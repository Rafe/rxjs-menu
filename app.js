...
var inTray = mouseEnterTray.map(() => {
  return true;
}).merge(mouseLeaveTray.map(() => {
  return false;
})).startWith(false);
...
}).do(removeOverlay).subscribe(closeTray);
...
},{"IrXUsu":5,"buffer":2}],7:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
}).call(this,require("IrXUsu"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/rx/dist/rx.all.js","/node_modules/rx/dist")
},{"IrXUsu":5,"buffer":2}]},{},[1])